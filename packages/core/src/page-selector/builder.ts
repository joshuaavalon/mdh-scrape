...
import type { Builder, EpFunc, MdhTvEpisodeScraperEpisodeContext } from "#type";
...
export class PageSelectorBuilder<T> implements Builder<EpFunc<T>> {
  ...
  private readonly validate: (from: T) => Error | null;
  private readonly postProcess: (from: T) => string;
